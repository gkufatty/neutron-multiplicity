...
constexpr std::array<TPCMapping, 8> tpc_map = {{
    {0, 1, TPC::TPC0, {33.49, 63.931},   {-62.076, 62.076}, {2.68, 64.3163}},
    {0, 2, TPC::TPC1, {3.07, 33.49},     {-62.076, 62.076}, {2.68, 64.3163}},
    {1, 3, TPC::TPC2, {33.49, 63.931},   {-62.076, 62.076}, {-64.3163, -2.68}},
    {1, 4, TPC::TPC3, {3.07, 33.49},     {-62.076, 62.076}, {-64.3163, -2.68}},
    {2, 5, TPC::TPC4, {-33.49, -3.07},   {-62.076, 62.076}, {2.68, 64.3163}},
    {2, 6, TPC::TPC5, {-63.931, -33.49}, {-62.076, 62.076}, {2.68, 64.3163}},
    {3, 7, TPC::TPC6, {-33.49, -3.07},   {-62.076, 62.076}, {-64.3163, -2.68}},
    {3, 8, TPC::TPC7, {-63.931, -33.49}, {-62.076, 62.076}, {-64.3163, -2.68}}
}};
...
struct Counters {
    ...
    int diff_tpc = 0; // reco protons in different TPC than vertex
    int same_tpc = 0; // reco protons in same TPC as vertex
    int recovered_n_induced = 0; // recovered neutron induced protons
};
